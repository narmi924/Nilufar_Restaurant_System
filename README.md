...
一个专为美莲花餐厅设计的现代化支出记录管理系统，采用双语界面（中文/维语）和Fluent Design设计风格。初始管理员用户名：Admin；初始管理员密码：000000.[![下载安装包](https://img.shields.io/badge/下载安装包-Download-brightgreen?style=for-the-badge)](https://github.com/narmi924/Nilufar_Restaurant_System/releases/download/v2.0/Nilufar_Restaurant_System_Setup.exe)
